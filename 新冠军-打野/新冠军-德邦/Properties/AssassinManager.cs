...
namespace XinZhao
{
    ...
    internal class AssassinManager
    {
        ...
        public void Load()
        {
            ...
            this.Config.AddItem(new MenuItem("TS", "主动的目标选择:").SetValue(new StringList(new[] { "赵信的目标选择", "L#的目标选择" }))).SetFontStyle(FontStyle.Regular, SharpDX.Color.GreenYellow)
            ...
            this.Config.AddItem(
                new MenuItem("Set", "目标选择模式:").SetValue(
                    new StringList(new[] { "单目标选择", "多目标选择" })))
                .SetFontStyle(FontStyle.Regular, SharpDX.Color.LightCoral)
                .SetTag(11);
            this.Config.AddItem(new MenuItem("Range", "范围（推荐：1150）:")).SetValue(new Slider(1150, (int)Program.E.Range, (int)Program.E.Range *2)).SetTag(11);
            ...
            this.Config.AddItem(new MenuItem("Draw.Range", Program.Tab + "范围").SetValue(new Circle(true, Color.Gray)).SetTag(11));
            this.Config.AddItem(new MenuItem("Draw.Enemy", Program.Tab + "积极的敌人").SetValue(new Circle(true, Color.GreenYellow)).SetTag(11));
            this.Config.AddItem(new MenuItem("Draw.Status", Program.Tab + "显示敌人:").SetValue(new StringList(new []{"Off", "Notification Text", "Sprite", "Both"}, 0)));
