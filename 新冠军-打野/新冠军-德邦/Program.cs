...
namespace XinZhao
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("Q群438230879：" + ChampionName, ChampionName, true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("ComboUseRS", Utils.Tab + "最小敌人数量:").SetValue(new Slider(2, 5, 1)));
            ...
            var mLane = new Menu("清线模式", "LaneMode");
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("EnabledFarmPermashow", "显示野区").SetValue(true))
                .ValueChanged +=
                    (s, ar) =>
                    {
