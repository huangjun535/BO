...
namespace YuLeVeigar.Champions.Veigar
{
    ...
    internal class Veigar
    {
        ...
        private static void SkinChance()
        {
            ...
            if (Vars.Menu["SkinChance"]["Enable"])
            {
                GameObjects.Player.SetSkin(GameObjects.Player.ChampionName, Vars.Menu["SkinChance"]["SkinName"].GetValue<MenuList>().Index);
            }
            else if (!Vars.Menu["SkinChance"]["Enable"])
            {
        ...
        public static void OnGapCloser(object sender, Events.GapCloserEventArgs args)
        {
            if (Vars.E.IsReady() && args.Sender.IsValidTarget(Vars.E.Range)
                ...
                && Vars.Menu["e"]["gapcloser"].GetValue<MenuBool>().Value)
            {
        ...
        public static void OnInterruptableTarget(object sender, Events.InterruptableTargetEventArgs args)
        {
            if (Vars.E.IsReady() && args.Sender.IsValidTarget(Vars.E.Range)
                && !Invulnerable.Check(args.Sender, DamageType.Magical, false)
                && Vars.Menu["e"]["interrupter"].GetValue<MenuBool>().Value)
            {
                Vars.E.Cast(args.Sender.ServerPosition);
            }
        }
        ...
        public void OnLoad()
        {
            ...
            SkinID = GameObjects.Player.BaseSkinId;
