...
namespace YuLeVeigar.Champions.Veigar
{
    ...
    internal partial class Logics
    {
        ...
        public static void Automatic(EventArgs args)
        {
            ...
            /// </summary>
            if (Vars.W.IsReady() && Vars.Menu["w"]["logical"].GetValue<MenuBool>().Value)
            {
            ...
            if (Vars.E.IsReady()
                ...
                >= Vars.Menu["e"]["enemies"].GetValue<MenuSliderButton>().SValue
                && Vars.Menu["e"]["enemies"].GetValue<MenuSliderButton>().BValue)
            {
