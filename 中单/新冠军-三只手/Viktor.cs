...
/*
 ...
 Viktor.cs is part of YuLeViktor.
...
using YuLeViktor.Abstracts;
using YuLeViktor.Args;
using YuLeViktor.Enumerations;
using YuLeViktor.Helpers;
using YuLeViktor.Library;
...
namespace YuLeViktor.Champions
{
    internal class Viktor : Champion
    {
                ...
                Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.LaneClear)
            {
                    ...
                    ResourceManager.Check("lasthit"))
                {
                    ...
                    if (minions.Any())
                    {
                        ...
                        {
                            var health = LeagueSharp.Common.HealthPrediction.GetHealthPrediction(
        ...
        protected override void Combo()
        {
            ...
            if (w)
            {
                ...
                if (target != null)
                {
                    WLogic(target, HitChance.VeryHigh);
                }
            }
            var rCast = false;
