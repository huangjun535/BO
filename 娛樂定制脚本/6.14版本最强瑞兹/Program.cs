    ...
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            if (Player.ChampionName != "Ryze")
                return;
			Game.PrintChat("<font color='#990033'><b>6.14鐗堟湰</b></font><font color='#CCFF66'><b>-绁炵骇娴佹氮</b></font><font color='#FF9900'><b>-濞涙▊VIP鑴氭湰缇わ細215226086</b></font>");
            ...
            Combo.AddItem(new MenuItem("Block", "Smart Block AutoAttack").SetValue(false));
