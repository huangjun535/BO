    ...
    public class CommonObjectDetector
    {
        ...
        private void GameOnOnUpdate(EventArgs args)
        {
                ...
                ChampionSpell.IsReady())
            {
                foreach (
                    var ability in
                        objectDrawings.Where(d => d.Object.IsValid && d.Position.IsOnScreen() && d.End > Game.Time))
                {
        ...
        private void DrawingOnOnEndScene(EventArgs args)
        {
            ...
            foreach (var ability in objectDrawings.Where(d => d.Object.IsValid && d.Position.IsOnScreen() && d.End > Game.Time))
            {
