...
namespace Ezreal
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("脚本信息").AddItem(new MenuItem("Sprite", "2015年5月份的OKTW单独版Ez"));
            Config.SubMenu("脚本信息").AddItem(new MenuItem("Hanhua", "汉化:花边"));
            Config.SubMenu("脚本信息").AddItem(new MenuItem("wearethebest", "当初我汉化的系列"));
            Config.SubMenu("脚本信息").AddItem(new MenuItem("Message", "不想相信什么战神香肠狗脚本"));
            Config.SubMenu("脚本信息").AddItem(new MenuItem("duiwaiqqqun", "不知廉耻的战神狗东西都是从这偷的免费脚本卖钱"));
