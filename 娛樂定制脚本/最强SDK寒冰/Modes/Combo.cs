...
using Settings = Ashe.Config.Modes.Combo;
...
namespace Ashe.Modes
{
    internal sealed class Combo : ModeBase
    {
        ...
        internal override void Execute()
        {
            ...
            {
                foreach (var hero in GameObjects.EnemyHeroes.Where(x => x.IsValidTarget() && !Invulnerable.Check(x, LeagueSharp.DamageType.Magical, false)))
                {
