...
namespace VayneHunter_Reborn.External.Cleanser
{
    class Cleanser
    {
        ...
        {
            var cleanserMenu = new Menu("净化", "dz191.vhr.cleanser");
            {
                ...
                cleanserMenu.AddKeybind("dz191.vhr.cleanser.use.combo", "净化按键", new Tuple<uint, KeyBindType>(32, KeyBindType.Press));
