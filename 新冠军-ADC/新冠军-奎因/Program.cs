namespace YuLeQuinn
{
    ...
    internal class Program
    {
        ...
        {
            if (ObjectManager.Player.ChampionName != "Quinn")
                return;

            Config = new Menu("新冠军奎因Q群438230879", "YuLeQuinn", true).SetFontStyle(System.Drawing.FontStyle.Regular, SharpDX.Color.Chartreuse);
        ...
        public static void CastSpell(Spell QWER, Obj_AI_Base target)
        {
            ...
            if (QWER.Speed != float.MaxValue && Common.CollisionYasuo(Player.ServerPosition, poutput2.CastPosition))
                return;
