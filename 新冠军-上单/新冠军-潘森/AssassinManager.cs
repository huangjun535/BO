...
namespace Pantheon
{
    ...
    internal class AssassinManager
    {
        ...
        public void Load()
        {
            ...
            this.Config.AddItem(
                new MenuItem("TS", "活动目标选择器：").SetValue(
                    new StringList(new[] {"潘森目标选择", "L#目标选择"})))
            ...
            this.Config.AddItem(
                ...
                .SetTag(11);
            this.Config.AddItem(new MenuItem("Range", "范围（推荐：1000）："))
                .SetValue(new Slider(1150, (int) Program.Q.Range, (int) Program.Q.Range*2))
                .SetTag(11);

            this.Config.AddItem(
                new MenuItem("Targets", "目标:").SetFontStyle(FontStyle.Regular, SharpDX.Color.Aqua).SetTag(11));
            foreach (var e in HeroManager.Enemies)
            {
                this.Config.AddItem(
                    new MenuItem("enemy_" + e.ChampionName, string.Format("{0}集中杀 {1}", Program.Tab, e.ChampionName))
            ...
            this.Config.AddItem(
                new MenuItem("Draw.Range", Program.Tab + "范围").SetValue(new Circle(true, Color.Gray)).SetTag(11));
            this.Config.AddItem(
                new MenuItem("Draw.Enemy", Program.Tab + "活动的敌人").SetValue(new Circle(true, Color.GreenYellow))
                    .SetTag(11));
            this.Config.AddItem(
                new MenuItem("Draw.Status", Program.Tab + "显示敌人:").SetValue(
